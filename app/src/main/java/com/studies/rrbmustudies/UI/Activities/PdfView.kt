...
import com.studies.rrbmustudies.databinding.ActivityPdfViewBinding
...
class PdfView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfUrl = intent.getStringExtra(KEY_URL)
     ...
     RetrievePDFFromURL(pdfView,binding.progressBarPDF).execute(pdfUrl)
        ...
        class RetrievePDFFromURL(pdfView: PDFView,val progressBar: ProgressBar) :
            ...
            override fun onPostExecute(result: InputStream?) {
                ...
                mypdfView.fromStream(result).onLoad {
