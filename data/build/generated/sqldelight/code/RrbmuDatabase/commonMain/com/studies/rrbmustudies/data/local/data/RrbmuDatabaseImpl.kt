package com.studies.rrbmustudies.`data`.local.`data`
...
import com.studies.rrbmustudies.`data`.local.DownloadedPaperQueries
...
private class RrbmuDatabaseImpl(
  ...
  override val downloadedPaperQueries: DownloadedPaperQueries = DownloadedPaperQueries(driver)
  ...
  public object Schema : SqlSchema<QueryResult.Value<Unit>> {
    ...
    override fun create(driver: SqlDriver): QueryResult.Value<Unit> {
      ...
      driver.execute(null,
          "CREATE INDEX downloaded_paper_date ON DownloadedPaper(downloadedAt DESC)", 0)
