...
import com.studies.rrbmustudies.`data`.local.`data`.newInstance
import com.studies.rrbmustudies.`data`.local.`data`.schema
import kotlin.Unit

public interface RrbmuDatabase : Transacter {
  public val cachedPaperQueries: CachedPaperQueries

  public val downloadedPaperQueries: DownloadedPaperQueries
